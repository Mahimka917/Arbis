        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="/#tariff" class="nav-link px-5 nav-item-c">Тарифы</a>
                    </li>
                    <li class="nav-item ">
                        <a href="news.php" class="nav-link pe-5 nav-item-c">Новости</a>
                    </li>
                    <li class="nav-item ">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                ...
                <a href="mailto:your@email.com" class="btn btn-primary btus">
