    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="loginModalLabel" style="width: 100%; color: #4170B7">Авторизация</h5>
                <span aria-hidden="true" style="color: #FD7C58; font-size: 24px; cursor: pointer;" data-bs-dismiss="modal">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="mb-3 text-left">
                        <a href="#" class="text-decoration-none" style="text-align: left">Забыли пароль?</a>
                    </div>
